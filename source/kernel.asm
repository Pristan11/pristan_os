;Pristan --- The  Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE Pristan_VER '1.0.0'	 ;OS version number
	%DEFINE Pristan_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as Pristan and its programs
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to Pristan OS****************************', 0
	os_version_msg		db 'Version ', Pristan_VER, 0

	os_init_msg2		db '                         Hardware HDIrmation                               ', 0
	os_version_msg2		db 'Version ', Pristan_VER, 0

	dialog_string_1		db 'Welcome to Pristan OS Modified By Kesavan', 0
	dialog_string_2		db 'Please select HDI for Hardware Info or', 0
...
_shell:
	...
	; display hardware HDI
	_cmd_HDI:		
	
	
	call _display_endl
	call _display_hardware_HDI	;display HDIrmation
...
_display_hardware_HDI:			; Procedure for printing Hardware HDI
